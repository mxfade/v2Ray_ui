...
install_v2-ui() {
    ...
    wget -N --no-check-certificate -O /usr/local/v2-ui-linux.tar.gz https://github.com/mikewubox/v2-ui/releases/download/${last_version}/v2-ui-linux.tar.gz
    if [[ $? -ne 0 ]]; then
    ...
    echo -e ""
    curl -o /usr/bin/v2-ui -Ls https://raw.githubusercontent.com/mikewubox/v2-ui/master/v2-ui.sh
